var exibeMensagem = function() {
   ...
   // console.log(escopoBloco); //Erro nessa linha... as variáveis declaradas usando a palavra-chave "let" (nesse caso: "let escopoBloco") não existem fora do escopo de bloco ("{ ... }") que ela foram declaradas. O mesmo acontece com variáveis declaradas usando a palavra-chave "const". Já variáveis declaradas com a palavra-chave "var" possui escopo global (visível dentro de todo o código do arquivo em questão, independentemente de onde for declarada).
}();
